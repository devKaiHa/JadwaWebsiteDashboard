...
import useAddAdvantage from "../hooks/useAddAdvantage";

const languages = ["en", "ar", "tr"];

function AddTurkishAdvantage() {
        ...
        <div className="card p-4">
          ...
          <input
            ...
            className={`input w-full ${
              errors[`title_${lang}`] ? "border border-red-500" : ""
            }`}
            disabled={isLoading}
          />
        </div>
        ...
        <div className="card p-4">
          ...
          <textarea
            ...
            className={`textarea w-full ${
              errors[`shortDescriptopn_${lang}`] ? "border border-red-500" : ""
            }`}
          />
  ...
  return (
    <Container>
      <div className="flex items-start justify-between mb-5">
        <h1 className="text-2xl font-bold mb-6">Add Advantage</h1>
...
export default AddTurkishAdvantage;
