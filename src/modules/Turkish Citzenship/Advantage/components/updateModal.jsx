...
import { useUpdateAdvantage } from "../hooks/useUpdateAdvantage";
...
function UpdateTurkishAdvantage() {
  const { id } = useParams(); // ✅ جلب الـ id من الراوت
  const { formData, setFormData, errors, handleUpdate, isLoading, isError } =
    useUpdateAdvantage(id);
        ...
        <div className="card p-4">
          ...
          <div className="flex justify-between mt-1 text-sm">
            ...
            <span className="text-gray-500">
              {formData.shortDescriptopn[lang]?.length || 0}/500 characters
            </span>
          </div>
        </div>
      </div>
  ...
  return (
    <Container>
      <div className="flex items-start justify-between mb-5">
        <h1 className="text-2xl font-bold mb-6">Update Advantage</h1>
...
export default UpdateTurkishAdvantage;
