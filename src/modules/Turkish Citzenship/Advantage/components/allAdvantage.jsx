...
import AllAdvantagesHook from "../hooks/UseAllAdvantage";
    ...
    <Container>
      <div className="card min-w-full">
        <div className="card-header flex justify-between items-center">
          <h3 className="card-title">All Advantages</h3>
          <div className="flex">
            <AddButton
              label="Add Advantage"
              onClick={() => navigate("/turkish-add-advantage")}
            />
            <div className="ml-2">
              <AddButton
                label="Update Title"
                    ...
                    <div className="flex gap-4 cursor-pointer">
                      <Tooltip title="Edit" placement="top">
                        <button
                          ...
                          onClick={() =>
                            navigate(`/turkish-update-advantage/${item._id}`)
                          }
                        >
      ...
      <GlobalDeleteModal
        ...
        text="Are you sure you want to delete this advantage? This action cannot be undone."
        butText="Delete"
