      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="card p-4">
          ...
          <input
            ...
            className={`input w-full ${errors[`title${lang.toUpperCase()}`] ? "border border-red-500" : ""}`}
            disabled={isLoading}
          />
        </div>
        ...
        <div className="card p-4">
          ...
          <textarea
            ...
            className={`textarea w-full ${errors[`shortDescriptopn${lang.toUpperCase()}`] ? "border border-red-500" : ""}`}
          />
  ...
  return (
    <Container>
      <div className="flex items-start justify-between mb-5">
        <h1 className="text-2xl font-bold mb-6">Update Turkish Service</h1>
...
export default UpdateTurkishService;
