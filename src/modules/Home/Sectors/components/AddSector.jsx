...
import { UseSectors } from "../hooks/UsePostSector";
import { ToastContainer } from "react-toastify";

const languages = ["ar", "en", "tr"];

function AddSectors() {
  const { formData, setFormData, errors, handlePost, isLoading } = UseSectors();
                ...
                <tr>
                  <td className="p-2 pt-4">
                    <div className="input-group">
                      ...
                      <input
                        placeholder={`${lang === "ar" ? "Arabic Name" : lang === "en" ? "English Name" : "Turkish Name"}`}
                        type="text"
