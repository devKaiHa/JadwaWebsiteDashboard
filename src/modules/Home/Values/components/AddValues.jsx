...
import { UseValues } from "../hooks/UsePostValues";
import { ToastContainer } from "react-toastify";

const languages = ["ar", "en", "tr"];

function AddValues() {
  const { formData, setFormData, errors, handlePost, isLoading } = UseValues();
  ...
  return (
    <Container>
      <div className="flex items-start justify-between mb-5">
        <h1 className="text-2xl font-bold mb-6">Add Value</h1>
