...
const UpdateInvestServiceModal = ({ id, sh, onClose }) => {
  const { formData, setFormData, handleUpdate, isLoading, isFetching } =
    useUpdateInvestService(id, sh, onClose);
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-2xl w-[50em] shadow-2xl">
        ...
        <div className="flex justify-between items-center border-b pb-3 mb-4">
          <h3 className="text-xl font-semibold">Update Invest Service</h3>
          <button
          ...
          <>
            ...
            <div className="flex justify-end mt-6 gap-3">
              ...
              <button
                ...
                disabled={isLoading}
              >
                {isLoading ? "Updating..." : "Update Invest Service"}
              </button>
            </div>
          </>
        )}
...
export default UpdateInvestServiceModal;
