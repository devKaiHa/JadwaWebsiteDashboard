...
import { useUpdateChooseUs } from "../hooks/useUpdateChooseUs"; // updated hook
                  ...
                  <td className="p-2 pt-4">
                    <div className="input-group">
                      ...
                      <input
                        ...
                        className={`input ${errors[`title${lang.toUpperCase()}`] ? "border border-red-500" : ""}`}
